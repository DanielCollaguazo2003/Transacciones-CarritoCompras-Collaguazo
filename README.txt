...
a persistence unit "transaccionesPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "transacciones/pom.xml":
...
artifact ("transacciones.war") is already built. You can build
